...
- **frequency_deviation** (*Optional*, enum): 
- **mute** (*Optional*, boolean): 
- **mono** (*Optional*, boolean): 
- **pga** (*Optional*, float): 
- **rfgain** (*Optional*, float): 
- **pa_bias** (*Optional*, boolean): 
- **pre_emphasis** (*Optional*, enum): 
- **pilot_tone_amplitude** (*Optional*, enum): 
- **bass_boost_control** (*Optional*, enum): 
- **auto_pa_down** (*Optional*, boolean): 
- **pa_down** (*Optional*, boolean): 
- **standby_enable** (*Optional*, boolean): 
- **audio_limiter_level** (*Optional*, enum): 
- **switch_mode** (*Optional*, enum): 
- **silence_detection** (*Optional*, boolean): 
- **silence_duration** (*Optional*, enum): 
- **silence_high** (*Optional*, enum): 
- **silence_low** (*Optional*, enum): 
- **silence_high_counter** (*Optional*, enum): 
- **silence_low_counter** (*Optional*, enum): 
- **au_enhance** (*Optional*, boolean): 
- **xtal_enable** (*Optional*, boolean): 
- **xtal_sel** (*Optional*, enum): 
- **ref_clk_enable** (*Optional*, boolean): 
- **ref_clk** (*Optional*, enum): 
- **alc_enable** (*Optional*, boolean): 
- **alc_gain** (*Optional*, float): 
- **alc_attack_time** (*Optional*, enum): 
- **alc_decay_time** (*Optional*, enum): 
- **alc_hold_time** (*Optional*, enum): 
- **alc_high** (*Optional*, enum): 
- **alc_low** (*Optional*, enum): 
...
pga                  x       x         x       -15           -15 - 12 (dB) [2]_
rfgain               x       x         x       108           95.5, 96.5, 97.5, 98.2, 98.9, 100, 101.5, 102.8, 105.1, 105.6, 106.2, 106.5, 107, 107.4, 107.7, 108 (dbUV) [3]_
mute                 x       x         x       False
mono                         x         x       False
...
silence_duration             x         x       100ms         50ms, 100ms, 200ms, 400ms, 1s, 2s, 4s, 8s, 16s, 24s, 32s, 40s, 48s, 56s, 60s, 64s [4]_
...
au_enhance                             x       False         
frequency_deviation          x         x       75kHz         75kHz, 112.5kHz, 150kHz, 187.5kHz [5]_
...
.. [2] KT0803 -12, -8, -4, 0, 4, 8, 12dB (lower two bits are ignored)
.. [3] pa_bias modifies the values of rfgain (105.1 => 107.2, 105.6 => 108, 106.2 => 108.7, 106.5 => 109.5, 107 => 110.3, 107.4 => 111, 107.7 => 111.7, 108 => 112.5), but only internally, parameters stay the same.
.. [4] KT0803K/M 50ms, 100ms, 200ms, 400ms, 1s, 2s, 4s, 8s only
.. [5] KT0803L 75kHz, 112.5kHz

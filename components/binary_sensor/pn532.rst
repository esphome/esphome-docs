...
App and send it to Home Assistant using the :ref:`api-homeassistant_tag_scanned_action`.
...
The following example can be used to write a random (psudo) UUID to the tag in the same format as the

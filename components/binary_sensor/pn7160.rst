...
The ``pn7160`` binary sensor platform provides an easy way to determine exactly when the PN7160 detects an NFC tag with
either a specific:
...
.. code-block:: yaml
    ...
    binary_sensor:
      - platform: pn7160
        ...
        name: "PN7160 Pulse 1 Tag"
      - platform: pn7160
        tag_id: pulse2
        name: "PN7160 Pulse 2 Tag"
      - platform: pn7160
        uid: 74-10-37-94
        name: "PN7160 NFC Tag"

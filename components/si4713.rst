...
Tuner (tuner) configuration variables:
------------------------------
...
Pilot (pilot) configuration variables:
------------------------------
...
Audio Compressor (compressor) configuration variables:
-----------------------------------------
...
Audio Limiter (limiter) configuration variables:
--------------------------------------

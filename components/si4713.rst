...
compressor / preset     Custom  Minimal, Aggressive, Custom
compressor / threshold  -40     -40 to 0 (dB)
compressor / attack     0.5ms   0.5ms, 1.0ms, 1.5ms, 2.0ms, 2.5ms, 3.0ms, 3.5ms, 4.0ms, 4.5ms, 5.0ms
compressor / release    1000ms  100ms, 200ms, 350ms, 525ms, 1000ms
compressor / gain       15      0 to 20 (dB)
limiter / enable        True

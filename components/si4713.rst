...
.. code-block:: yaml
    ...
    si4713_i2c:
      ...
      sensor:
        chip_id:
          name: Chip Part Number
        chip_revision:
          name: Chip Revision
        chip_firmware:
          name: Chip Firmware Revision
        chip_component:
          name: Chip Component Revision
        chip_library:
          name: Chip Library Revision
        chip_patch:
          name: Chip Patch ID
        frequency:
          name: Frequency
...
- **chip_id** (*Optional*, string): Chip Part Number. (example: Si4713)
- **chip_revision** (*Optional*, string): Chip Revision. (example: B)
- **chip_firmware** (*Optional*, string): Chip Firmware Revision. (example: 3.0)
- **chip_component** (*Optional*, string): Chip Component Revision. (example: 3.0)
- **chip_library** (*Optional*, string): Chip Library Revision. (example: R8)
- **chip_patch** (*Optional*, string): Chip Patch ID. (example: 0)
...
analog / level          636     0 to 1023 mV\ :sub:`PK`

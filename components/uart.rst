...
- **nr_bits** (*Optional*, int): The number of bits used on the UART bus. Options: 5 to 8. Defaults to 8.
- **parity** (*Optional*, str): The parity used on the UART bus. Options: ``none``, ``even``, ``odd``. Defaults to ``none``.

...
- **frequency** (*Optional*, float): Between 76MHz and 108MHz. Step size is 0.05MHz
...
- **pre_emphasis** (*Optional*, enum): Pre-emphasis time constant. 50us or 75us.
...
- **xtal_frequency** (*Optional*, enum): Crystal frequency. 12MHz or 24MHz.

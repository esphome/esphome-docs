...
.. code-block:: yaml
    ...
    # Expample configuration for WeMos D1 with SSD1306 shield 
    ...
    # Font definition for SSD1306 display
    # TrueType fonts are used, e.g. arial.ttf from Windows OS
    # Save font files in /config/esphome folder 
    # The font name should be lower case
    # more at https://esphome.io/cookbook/display_time_temp_oled.html#define-the-fonts
    font:
     - file: "arial.ttf"
       id: font1
       size: 8
    ...
    # SSD1306 Shield
    # Default address 0x3C, model SSD1306 64x48
    display:
      - platform: ssd1306_i2c
        ...
        lambda: |-
                // Print "Hello World"
                it.printf(0, 0, id(font1), "Hello World");
...
- :doc:`/cookbook/display_time_temp_oled`
- :ghedit:`Edit`

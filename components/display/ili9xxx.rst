...
For modify the SPI setting see :ref:`spi <generic-spi-device-component>`. The default **data_rate** is set to ``40MHz`` and the **spi_mode** mode is ``MODE0`` but some displays require ``MODE3`` (*).

...
- **aec2** (*Optional*, bool): Whether to enable Auto Exposure Control 2. Defaults to ``false``.
- **ae_level** (*Optional*, int): The auto exposure leve to apply to the picture, from -2 to 2. Defaults to ``0``.

...
- **client_certificate** (*Optional*, string): Only with ``esp-idf``. Client certificate in PEM format.
- **client_certificate_key** (*Optional*, string): Only with ``esp-idf``. Client private key in PEM format.

...
- **protocol** (**Required**, string): Choose one of Arduino-HeatpumpIR's supported protcols: 
    ...
    | ``airway``          | ``greeyap``               | ``nibe``              |
    +---------------------+---------------------------+-----------------------+
    | ``aux``             | ``greeyt``                | ``panasonic_altdke``  |
    +---------------------+---------------------------+-----------------------+
    | ``ballu``           | ``hisense_aud``           | ``panasonic_ckp``     |
    +---------------------+---------------------------+-----------------------+
    | ``bgh_aud``         | ``hitachi``               | ``panasonic_dke``     |
    +---------------------+---------------------------+-----------------------+
    | ``carrier_mca``     | ``hyundai``               | ``panasonic_jke``     |
    +---------------------+---------------------------+-----------------------+
    | ``carrier_nqv``     | ``ivt``                   | ``panasonic_lke``     |
    +---------------------+---------------------------+-----------------------+
    | ``carrier_qlima_1`` | ``midea``                 | ``panasonic_nke``     |
    +---------------------+---------------------------+-----------------------+
    | ``carrier_qlima_2`` | ``mitsubishi_fa``         | ``samsung_aqv``       |
    +---------------------+---------------------------+-----------------------+
    | ``daikin``          | ``mitsubishi_fd``         | ``samsung_aqv12msan`` |
    +---------------------+---------------------------+-----------------------+
    | ``daikin_arc417``   | ``mitsubishi_fe``         | ``samsung_fjm``       |
    +---------------------+---------------------------+-----------------------+
    | ``daikin_arc480``   | ``mitsubishi_heavy_fdtc`` | ``sharp``             |
    +---------------------+---------------------------+-----------------------+
    | ``electroluxyal``   | ``mitsubishi_heavy_zj``   | ``toshiba``           |
    +---------------------+---------------------------+-----------------------+
    | ``fuego``           | ``mitsubishi_heavy_zm``   | ``toshiba_daiseikai`` |
    +---------------------+---------------------------+-----------------------+
    | ``fujitsu_awyz``    | ``mitsubishi_heavy_zmp``  | ``vaillantvai8``      |
    +---------------------+---------------------------+-----------------------+
    | ``gree``            | ``mitsubishi_kj``         | ``zhjg01``            |
    +---------------------+---------------------------+-----------------------+
    | ``greeyaa``         | ``mitsubishi_msc``        | ``zhlt01``            |
    +---------------------+---------------------------+-----------------------+
    | ``greeyac``         | ``mitsubishi_msy``        |                       |
    +---------------------+---------------------------+-----------------------+
    | ``greeyan``         | ``mitsubishi_sez``        |                       |
    +---------------------+---------------------------+-----------------------+

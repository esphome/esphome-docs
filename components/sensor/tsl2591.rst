...
- **device_factor** (*Optional*, float) The default is ``53.0``.
  The device factor to be used as part of the lux equation for **caclulated_lux**.
- **glass_attenuation_factor** (*Optional*, float) The default is ``7.7``.
  The glass attenuation factor to be used as part of the lux equation for **caclulated_lux**.

...
- **gesture_led_drive** (*Optional*, int): The gesture LED drive level in mA. One of 100, 50, 25, 12.5. Defaults to ``100``.
- **gesture_gain** (*Optional*, int): The proximity gain level. One of 1, 2, 4, 8. Defaults to ``4``.
- **gesture_wait_time** (*Optional*, int): The gesture wait time in ms. One of 0, 2.8, 5.6, 8.4, 14, 22.4, 30.8, 39.2. Defaults to ``2.8``.

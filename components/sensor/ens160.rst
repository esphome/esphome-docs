...
.. note::
    On very first power-up of ENS160, there is a 1 hour initial start up delay before readings will be available.
...
- **compensation** (*Optional*): The block containing sensors used for compensation. 
  ...
  ENS160 internally assumes 25°C temperature and 50% humidity, with readings noticeably moving with actual changes in temperature and humidity.

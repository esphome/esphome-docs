...
- **reset** (*Optional*, boolean): Whether to reset the BL0942 chip on startup. Defaults to ``true`` which resets the charge counter to zero and potentially loses data.

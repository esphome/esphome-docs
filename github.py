...
def ghsources_role(name, rawtext, text, lineno, inliner, options=None, content=None):
    text, value = split_text_value(text)
    if text is None:
        text = "View Source Code"
    ref = f"https://github.com/esphome/esphome/blob/dev/{value}"
...
def setup(app):
    ...
    app.add_role("ghsources", ghsources_role)

...
When you create a new integration, your new component will inherit from :ghsources:`Component <esphome/core/component.h>`.
...
:ghsources:`PollingComponent <esphome/core/component.h>`). In these methods you should retrieve the latest data from the

...
<span id="remote_transmitter-transmit_rc5x"></span>
...
- **address** (**Required**, int, [templatable](/automations/templates)): The address to send, see dumper output for more details.
- **command** (**Required**, int, [templatable](/automations/templates)): The RC5X command to send.
- **extension** (**Required**, int, [templatable](/automations/templates)): The RC5X extension field to send.
- All other options from [Remote Transmitter Actions](#remote_transmitter-transmit_action).

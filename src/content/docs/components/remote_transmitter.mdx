...
<span id="remote_transmitter-transmit_hob2hood"></span>

### `remote_transmitter.transmit_hob2hood` Action

This [action](/automations/actions#all-actions) sends a Hob2Hood infrared remote code to a remote transmitter.
...
- **command** (**Required**, enum, [templatable](/automations/templates)): The Hob2Hood command to send, see dumper output for more info.
  - ``light_off``
  - ``light_on``
  - ``fan_off``
  - ``fan_low``

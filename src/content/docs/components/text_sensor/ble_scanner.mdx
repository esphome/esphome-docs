---
description: "Instructions for setting up BLE scanner text sensors in ESPHome."
...
See your BLE tracker's configuration variables (for example [ESP32 BLE Tracker](/components/esp32_ble_tracker#config-esp32_ble_tracker)) for instructions for setting up scan parameters.

...
The `sdl` display component must be configured to use this, and it must have a window - a display with
[headless](/components/display/sdl#headless-operation) set receives no mouse events.

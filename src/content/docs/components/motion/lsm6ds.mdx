...
- **address** (*Optional*, int): Manually specify the I²C address of the sensor. Defaults to `0x6A`, on some
  boards it may need to be set to `0x6B`.
...
As an IMU with both an accelerometer and a gyroscope, the LSM6DS supports all of the

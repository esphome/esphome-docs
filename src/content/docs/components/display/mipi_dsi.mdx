...
| JC1060P470-V2          | Guition        | [JC1060P470-V2 product page](https://aliexpress.com/item/1005008328088576.html)                                  |
...
> [!NOTE]
The Guition JC1060P470 (also sold under JC1060P470C_I_W_Y) has two hardware revisions with different display panels requiring different model selections.

Units whose rear label shows `V2` after the material number (2026 batches) should use model `JC1060P470-V2`.
Units without the `V2` marking should use model `JC1060P470`.

Selecting the incorrect driver will show a white or blank screen with a band of vertical noise.

...
<ImgTable items={[
  ...
  ["Improv via BLE", "/components/esp32_improv/", "improv.svg", "dark-invert"],
  ["BTHome BLE", "/components/bthome/", "bthome.png", "dark-invert"],
...
<ImgTable items={[
  ...
  ["BTHome Sensor", "/components/sensor/bthome/", "bthome.png", "dark-invert"],
...
<ImgTable items={[
  ...
  ["BTHome Binary Sensor", "/components/binary_sensor/bthome/", "bthome.png", "dark-invert"],
...
<ImgTable items={[
  ...
  ["BTHome Text Sensor", "/components/text_sensor/bthome/", "bthome.png", "dark-invert"],

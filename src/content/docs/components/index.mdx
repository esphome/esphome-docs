...
<ImgTable items={[
  ...
  ["M5Stack Unit LCD", "/components/display/m5stack_unit_lcd/", "m5stack_unit_lcd.jpg"],
...
<ImgTable items={[
  ...
  ["M5Stack Unit LCD Backlight", "/components/light/m5stack_unit_lcd/", "brightness-medium.svg", "dark-invert"],

...
[RP2 BLE Tracker](/components/rp2_ble_tracker/) on RP2040/RP2350, the
[LN882H BLE Tracker](/components/ln882h_ble_tracker/) on LN882x, or the
[RTL87xx BLE Tracker](/components/rtl87xx_ble_tracker/) on RTL87xx.
...
- **BK72xx, LN882x and RTL87xx** — **advertisement-only**. These controllers do not expose the
  GATT client the proxy needs for connections, so Home Assistant uses the device for
  advertisements only and will not route connections through it; requires the
  [BK72xx BLE Tracker](/components/bk72xx_ble_tracker/),
  [LN882H BLE Tracker](/components/ln882h_ble_tracker/) or
  [RTL87xx BLE Tracker](/components/rtl87xx_ble_tracker/) component. This is independent of the
...
must be part of the configuration — [BK72xx BLE Tracker](/components/bk72xx_ble_tracker/),
[LN882H BLE Tracker](/components/ln882h_ble_tracker/) or

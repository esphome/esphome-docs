...
exposed via the logger, mDNS, the device_info response via the native API and the
[Sendspin](/components/sendspin/) hub's device information. The format of the name

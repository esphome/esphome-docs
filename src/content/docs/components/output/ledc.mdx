...
On RP2040 or RP2350-based platforms, the [`rp2040_pwm`](/components/output/rp2040_pwm/)
component provides similar functionality.
...
- [RP2040/RP2350 Hardware PWM Output](/components/output/rp2040_pwm)

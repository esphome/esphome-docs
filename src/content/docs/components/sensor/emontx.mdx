...
sensor:
  - platform: emontx
    ...
    filters:
      ...
      - multiply: 3600  # adjust to your meter — see table below
```
...
|---|---|---|---|
| Electricity | 1000 imp/kWh | `3600` | `W` |
| Electricity | 2000 imp/kWh | `1800` | `W` |
| Electricity | 10000 imp/kWh | `360` | `W` |
| Water | 1 pulse = 1 L | `60` | `L/min` |
| Water | 1 pulse = 10 L | `600` | `L/min` |
| Gas | 1 pulse = 0.01 m³ | `36` | `m³/h` |
| Gas | 1 pulse = 0.1 m³ | `360` | `m³/h` |

General formulas:
- **Electricity (W)**: `multiply = 3600000 / impulse_constant`
...
> [!NOTE]
> The raw EmonTx pulse counter is monotonically increasing and does not reset on reboot.
> Use `state_class: total_increasing` when exposing it as a cumulative counter.
> The derived instantaneous rate sensor shown above uses `state_class: measurement`.

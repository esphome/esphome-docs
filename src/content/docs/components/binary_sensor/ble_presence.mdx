---
description: "Instructions for setting up BLE presence binary sensors in ESPHome."
title: "Bluetooth Low Energy Device"
---
...
however, you can use the BLE tracker hub without any binary sensors attached and read through

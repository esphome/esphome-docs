...
From this release, ESPHome will show a configuration error when attempting to use ``mode: INPUT_PULLUP`` for GPIO0 / Pin 0.
This is because GPIO0 is always pulled up and you only need to set ``mode: INPUT`` or use the newer syntax:

...
- The ``xiaomi_`` BLE platforms have been renamed to match their model numbers (:esphomepr:`755`).
   ...
   - ``xiaomi_mijia`` -> :doc:`xiaomi_lywsdcgq </components/sensor/xiaomi_ble>`
   - ``xiaomi_miflora`` -> :doc:`xiaomi_hhccjcy01 </components/sensor/xiaomi_ble>`
...
- New class CustomAPIDevice to declare user-defined services straight from custom components.
